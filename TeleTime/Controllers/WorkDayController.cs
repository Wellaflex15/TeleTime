...
namespace TeleTime.Controllers
{
    public class WorkDayController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "WorkDayID,NameOfDay,DayOfWork")] WorkDay workDay)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "WorkDayID,NameOfDay,DayOfWork")] WorkDay workDay)
        {
            if (ModelState.IsValid)
            {
